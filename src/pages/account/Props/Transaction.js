...
const Transaction = ({user, getBikData, resetBikData, update_local_user, getInnData, resetInnData,}) => {
...
export default connect(mapStateToProps, {updateCardData, getBikData, resetBikData, update_local_user, getInnData, resetInnData,})(Transaction)