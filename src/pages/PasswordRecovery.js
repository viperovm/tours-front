...
const PasswordRecovery = ({ isAuthenticated, login, checkAuthenticated, error, clear_errors,
...
export default connect(mapStateToProps, { login, checkAuthenticated, clear_errors, reset_password })(PasswordRecovery)
