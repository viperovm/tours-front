              ...
              <div className={styles.leader_approved}>
                ...
                <div className={`${styles.leader_approved_image_text} ${docs_confirmed ? styles.approved : ''}`}>
                  <div className={styles.leader_approved_image}>
                    <svg width="22" height="24" viewBox="0 0 22 24" fill={`${docs_confirmed ? "#84BB59" : "black"}`} fill-opacity={`${docs_confirmed ? "1" : "0.25"}`} xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`${styles.leader_approved_image_text} ${phone_confirmed ? styles.approved : ''}`}>
                  <div className={styles.leader_approved_image}>
                    <svg width="16" height="24" viewBox="0 0 16 24" fill={`${phone_confirmed ? "#84BB59" : "black"}`} fill-opacity={`${phone_confirmed ? "1" : "0.25"}`} xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`${styles.leader_approved_image_text} ${email_confirmed ? styles.approved : ''}`}>
                  <div className={styles.leader_approved_image}>
                    <svg width="22" height="24" viewBox="0 0 22 24" fill={`${email_confirmed ? "#84BB59" : "black"}`} fill-opacity={`${email_confirmed ? "1" : "0.25"}`} xmlns="http://www.w3.org/2000/svg">
