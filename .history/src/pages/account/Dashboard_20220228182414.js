...
import Exit from '../../asse/img/get_out.svg'
import Close from '../../asse/img/close.svg'
import CloseRed from '../../asse/img/close_red.svg'
import Done from '../../asse/img/done_green.svg'
import Positive from '../../asse/img/positive.svg'
import Negative from '../../asse/img/negative.svg'
...
const Dashboard = ({ status, user, logout, setPage }) => {
  useEffect(() => {
    setPage('account')
  }, [])
...
export default connect(mapStateToProps, { logout, setPage })(Dashboard)
